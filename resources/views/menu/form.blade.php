        ...
        <div class="col-xl-6">
            <div class="menud mb-4">
                <div class="menud-header d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted float-end">Create new Menu</small>
                </div>
                <div class="menud-body">
                    <form id="menuForm" enctype="multipart/form-data"> <!-- Add enctype for file upload -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @if (isset($menu->icon))
                                <img src="{{ $menu->icon }}" alt="" style="width: 50%">
                            @endif
                        ...
                        <button id="btn-submit-menu" type="submit" class="btn btn-primary">
    ...
    <script>
        (function() {
            ...
            if (dropzoneBasic) {
                ...
                document.querySelector('#menuForm').addEventListener('submit', async function(event) {
                    $("#btn-submit-menu").prop("disabled", true);
                    $("#loading-indicator").removeClass("d-none");
                    const isEdit = '{{ isset($menu) }}'

                    event.preventDefault();

                    const menuName = document.querySelector('#name').value;
                    ...
                    $("#btn-submit-menu").prop("disabled", false);
