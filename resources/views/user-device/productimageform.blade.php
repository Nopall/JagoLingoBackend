        ...
        <div class="col-xl-6">
            <div class="productimaged mb-4">
                <div class="productimaged-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">productimage</h5>
                    <small class="text-muted float-end">Create new Product Image</small>
                </div>
                    ...
                    <form id="productimageForm" enctype="multipart/form-data"> <!-- Add enctype for file upload -->
                        ...
                        <div class="mb-3">
                            ...
                            @if (isset($productimage->image))
                                <img src="{{ $productimage->image }}" alt="" style="width: 50%">
                            @endif
        ...
        (function() {
            ...
            if (dropzoneBasic) {
                ...
                document.querySelector('#productimageForm').addEventListener('submit', async function(event) {
                    ...
                    const isEdit = '{{ isset($productimage) }}'
                    ...
                    let url = "{{ route('productimage.create', ['id' => $id]) }}";
                    @if (isset($productimage->id))
                        url = "{{ route('productimage.update', $productimage->id) }}";
                    @endif
                    ...
                    window.location = "{{ route('product.image' , ['id' => $id]) }}";
